...
export class Weth_Wbtc_SushiSwap extends ethereum.SmartContract {
  static bind(address: Address): Weth_Wbtc_SushiSwap {
    return new Weth_Wbtc_SushiSwap("Weth_Wbtc_SushiSwap", address);
  }
